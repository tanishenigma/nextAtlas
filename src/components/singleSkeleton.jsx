...
function singleSkeleton() {
  return (
    <div className="bg-zinc-700 text-white flex flex-col justify-center p-2 rounded-md m-3 hover:scale-105 ease-in-out transition-transform duration-200 w-72 h-72 ">
